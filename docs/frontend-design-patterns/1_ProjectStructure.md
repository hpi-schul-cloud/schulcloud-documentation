...
When working with building-blocks, be careful about circular dependencies between modules. If you run into issues, check the [Troubleshooting page](8_Troubleshooting.md#circular-dependencies) for guidance on identifying and resolving circular dependencies.
